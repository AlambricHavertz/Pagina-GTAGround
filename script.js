let first = "191.101.251.111:7775";
let second = "https://discord.gg/jAy7rsrpCG";
let third = "https://www.youtube.com/@GTAGroundRoleplay";
...
function openLink(value) {
    if (value == "first") {
        alert('Esta es nuestra IP: 191.101.251.111:7775')
    }
    if (value == "second") {
        window.location.href = "https://discord.gg/jAy7rsrpCG";
    }
    if (value == "third") {
        window.location.href = "https://www.youtube.com/@GTAGroundRoleplay";
    }
    if (value == "start") {
